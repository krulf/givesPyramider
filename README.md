...
Kortudsnittene kan findes ved at søge på https://loar.kb.dk. Du finder ØST og NORD koordinat i UTM32-ETRS89 format i filen [DKiMinecraft.ods](DKiMinecraft.ods). Du kan også søge ved at bruge denne hjemmeside: (https://www.orient-dsk.dk/psch/viewpage.php?page_id=16&mode=soeg), lavet af Patrick Schunck. Han har også skrevet en artikel om det: https://www.orient-dsk.dk/psch/infusions/articles/articles.php?article_id=10
